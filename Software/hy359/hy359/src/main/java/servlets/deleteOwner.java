...
public class deleteOwner extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String owner_id = request.getParameter("owner_id_admin");
        System.out.println("\n\n\n Owner id: " + owner_id + "\n\n\n");
        HttpSession session = request.getSession();
        try (PrintWriter out = response.getWriter()) {
            EditPetOwnersTable eut = new EditPetOwnersTable();
            boolean res = eut.deletePetOwnerByOwnerId(owner_id);
            if (res == true) {
            ...
            Logger.getLogger(GetOwner.class.getName()).log(Level.SEVERE, null, ex);
